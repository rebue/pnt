...
public class PntAccountSvcImpl extends BaseSvcImpl<java.lang.Long, PntAccountJo, PntAccountDao, PntAccountMo, PntAccountMapper> implements PntAccountSvc {
    ...
    public Ro modifyIncome(ModifyIncomeTo to) {
        ...
        Ro ro = new Ro();
        if (to.getAccountId() == null || to.getNewIncome() == null || to.getOldIncome() == null || to.getNewTotalIncome() == null || to.getOldTotalIncome() == null || to.getNewModifiedTimestamp() == null || to.getOldModifiedTimestamp() == null) {
        ...
        _log.info("修改收益信息的参数为：{}", to);
        int updateIncomeResult = _mapper.updateIncome(to.getAccountId(), to.getNewIncome(), to.getOldIncome(), to.getNewTotalIncome(), to.getOldTotalIncome(), to.getNewModifiedTimestamp(), to.getOldModifiedTimestamp());
