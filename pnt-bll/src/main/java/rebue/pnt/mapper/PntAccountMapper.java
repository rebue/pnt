...
public interface PntAccountMapper extends MybatisBaseMapper<PntAccountMo, Long> {
    ...
    int modifyAccount(@Param("id") Long id, @Param("newPoints") BigDecimal newPoints, @Param("oldPoints") BigDecimal oldPoints, @Param("newModifiedTimestamp") Long newModifiedTimestamp, @Param("oldModifiedTimestamp") Long oldModifiedTimestamp);
}
