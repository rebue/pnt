...
public class PntAccountCtrl {
     ...
     */
    private final static Logger _log             = LoggerFactory.getLogger(PntAccountCtrl.class);
    ...
    Ro add(@RequestBody final PntAccountMo mo) throws Exception {
    ...
    Ro modify(@RequestBody final PntAccountMo mo) throws Exception {
    ...
    PageInfo<PntAccountMo> list(final PntAccountMo mo, @RequestParam(value = "pageNum", required = false) Integer pageNum,
        ...
        final PageInfo<PntAccountMo> result = svc.list(mo, pageNum, pageSize);
    ...
    PntAccountMo getById(@RequestParam("id") final java.lang.Long id) {
